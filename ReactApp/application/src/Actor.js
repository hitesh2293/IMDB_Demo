        ...
        return (
            <div id="AddUser">
                ...
                <table>
                    <tr>
                        <td>Actor Name</td>
                        <td><input type="textbox" id='txtActorName' onChange={this.ActorNameChange}></input></td>
                    </tr>
                    <tr>
                        <td>Gender</td>
                        <td>
                    ...
                    <tr>
                        <td colSpan='2'>
                            <div className="centerButton" >
                                <input type="button" value="Save Actor Details" onClick={this.onSaveClick}></input>
                            </div>
                        </td>
                    </tr>
                </table>
